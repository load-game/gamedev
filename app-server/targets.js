...
export function applyTargetEnv(target) {
  ...
  if (typeof target.worldAuthToken === 'string') process.env.WORLD_AUTH_TOKEN = target.worldAuthToken
  if (typeof target.authToken === 'string') process.env.WORLD_AUTH_TOKEN = target.authToken
